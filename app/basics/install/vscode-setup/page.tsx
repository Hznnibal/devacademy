...
export default function VSCodeGuidePage() {
    return (
        <div className="container mx-auto py-12 px-4">
            <h1 className="text-4xl font-bold text-center mb-12">Guide: Visual Studio Code</h1>

            <div className="space-y-12">
                {/* Section: What is VSCode? */}
                <section>
                    <h2 className="text-2xl font-bold mb-4">What is Visual Studio Code?</h2>
                    <Card className="p-6">
                ...
                <section>
                    <h2 className="text-2xl font-bold mb-4">How to Install Visual Studio Code?</h2>
                    <Card className="p-6">
                ...
                <section>
                    <h2 className="text-2xl font-bold mb-4">How to Use Visual Studio Code?</h2>
