...
const FontsPage: React.FC = () => {
    return (
        <div className="px-5 py-8 font-sans">
            <h1 className="text-3xl font-semibold mb-6 text-center">CSS: Box Models</h1>
            ...
            <section className="mb-6">
                <h2 className="text-2xl font-semibold mb-2">The Standard Box Model</h2> <div className="border-b border-gray-300 mb-6" />
            ...
            <section className="mb-6">
                <h2 className="text-2xl font-semibold mb-2">Content Box (Height & Width)</h2> <div className="border-b border-gray-300 mb-6" />
                ...
                <p className="text-lg leading-relaxed mb-4">
                    ...
                    is determined by the <code className="bg-gray-200 text-red-600 px-1 rounded">width</code>
                    and <code className="bg-gray-200 text-red-600 px-1 rounded">height</code> properties.
                </p>
                <p className="text-lg leading-relaxed mb-4">
                    Additional properties like <code className="bg-gray-200 text-red-600 px-1 rounded">min-width</code>,
                    <code className="bg-gray-200 text-red-600 px-1 rounded">max-width</code>,
                    <code className="bg-gray-200 text-red-600 px-1 rounded">min-height</code>,
                    and <code className="bg-gray-200 text-red-600 px-1 rounded">max-height</code>
                    can limit the dimensions of the content box.
                </p>
            </section>

            <section className="mb-6">
                <h2 className="text-2xl font-semibold mb-2">Padding Box</h2> <div className="border-b border-gray-300 mb-6" />

                <p className="text-lg leading-relaxed mb-4">
                    Padding is the space between the content and the border.
                    It can be set using the shorthand property
                    <code className="bg-gray-200 text-red-600 px-1 rounded">padding</code>
                    or individual properties
                    (<code className="bg-gray-200 text-red-600 px-1 rounded">padding-top</code>,
                    <code className="bg-gray-200 text-red-600 px-1 rounded">padding-right</code>,
                    <code className="bg-gray-200 text-red-600 px-1 rounded">padding-bottom</code>,
                    and <code className="bg-gray-200 text-red-600 px-1 rounded">padding-left</code>).
                </p>
            </section>

            <section className="mb-6">
                <h2 className="text-2xl font-semibold mb-2">Border Box</h2> <div className="border-b border-gray-300 mb-6" />

                <p className="text-lg leading-relaxed mb-4">
                    The border surrounds the padding and content. By default, the border size is 0, making it invisible.
                    The shorthand property <code className="bg-gray-200 text-red-600 px-1 rounded">border</code>
                    allows defining the width, style, and color of the border:
                </p>
                <ul className="list-disc list-inside space-y-2 mt-2">
                    <li><code className="bg-gray-200 text-red-600 px-1 rounded">border-width</code></li>
                    <li><code className="bg-gray-200 text-red-600 px-1 rounded">border-style</code></li>
                    <li><code className="bg-gray-200 text-red-600 px-1 rounded">border-color</code></li>
                </ul>
            </section>

            <section className="mb-6">
                <h2 className="text-2xl font-semibold mb-2">Margin Box</h2> <div className="border-b border-gray-300 mb-6" />
                <p className="text-lg leading-relaxed mb-4">
            ...
            <section className="mb-6">
                <h2 className="text-2xl font-semibold mb-2">Example</h2> <div className="border-b border-gray-300 mb-6" />
                <CodeBlock code={`/* CSS Example */
p {
    width: 100px;
    height: auto;
    padding: 10px 20px;
    ...
    margin: 20px 0;
            ...
            <section className="mb-6">
                <h2 className="text-2xl font-semibold mb-2">Interactions Overview</h2> <div className="border-b border-gray-300 mb-6" />
                <p className="text-lg leading-relaxed mb-4">
            ...
            <section className="mb-6">
                <h2 className="text-2xl font-semibold mb-2">Overflow</h2> <div className="border-b border-gray-300 mb-6" />
                <p className="text-lg leading-relaxed mb-4">
                    ...
                    The <code className="bg-gray-200 text-red-600 px-1 rounded">overflow</code> property controls how to handle this situation.
                </p>
                ...
                <h4 className="text-xl font mb-2">Example</h4>
...
.clipped { overflow: hidden; }`} />
            ...
            <section className="mb-6">
                <h2 className="text-2xl font-semibold mb-2">Box Types</h2> <div className="border-b border-gray-300 mb-6" />
                <p className="text-lg leading-relaxed mb-4">
                    ...
                    The <code className="bg-gray-200 text-red-600 px-1 rounded">display</code> property determines the type of box for an element.
                </p>

                <h4 className="text-xl font mb-2">Block Boxes</h4>
                <p className="text-lg leading-relaxed mb-4">
                ...
                <h4 className="text-xl font mb-2">Inline Boxes</h4>
                <p className="text-lg leading-relaxed mb-4">
...
.block { display: block; }`} />
            ...
            <section className="mb-6">
                <h2 className="text-2xl font-semibold mb-2">CSS: The Flexible Box Model (Flexbox)</h2> <div className="border-b border-gray-300 mb-6" />
            ...
            <section className="mb-6">
                <h2 className="text-2xl font-semibold mb-2">Practice Activity</h2> <div className="border-b border-gray-300 mb-6" />
                <p className="text-lg leading-relaxed mb-4">
            ...
            <section className="mb-6">
                <h2 className="text-2xl font-semibold mb-2">Key Takeaways</h2> <div className="border-b border-gray-300 mb-6" />
                <ul className="list-disc list-inside space-y-2 text-lg">
                    <li>
                        In CSS, the formatting of a targeted element can be modified by adjusting its content
                        (<code className="bg-gray-200 text-red-600 px-1 rounded">height</code> and <code className="bg-gray-200 text-red-600 px-1 rounded">width</code>),
                        internal margins (<code className="bg-gray-200 text-red-600 px-1 rounded">padding</code>), border
                        (<code className="bg-gray-200 text-red-600 px-1 rounded">border</code>), and external margins
                        (<code className="bg-gray-200 text-red-600 px-1 rounded">margin</code>).
                    </li>
                    <li>
                        Overflow can be managed with the <code className="bg-gray-200 text-red-600 px-1 rounded">overflow</code> property to handle content
                        ...
                        <code className="bg-gray-200 text-red-600 px-1 rounded">visible</code>, and <code className="bg-gray-200 text-red-600 px-1 rounded">scroll</code>.
                    </li>
                    <li>
                        Box types can be <code className="bg-gray-200 text-red-600 px-1 rounded">block</code> or <code className="bg-gray-200 text-red-600 px-1 rounded">inline</code>.
                        The <code className="bg-gray-200 text-red-600 px-1 rounded">display</code> property can be used to switch between these types.
                    </li>
                </ul>
            </section>
        </div >
