...
const MvcWithSymfony: React.FC = () => {
    return (
        <div className="px-5 py-8 font-sans">
            ...
            <p className="text-base mb-4">Start by reading this introduction to <a href="/MVC/symfony/symfony01_intro/mvcarchitecture" className="text-blue-500">MVC architecture.</a></p>
