...
const UnitTestsWithPHPUnitAndSymfony: React.FC = () => {
    return (
        <div className="px-5 py-8 font-sans">
            ...
            <img src="/path-to-screenshot" alt="Folder structure screenshot" className="screenshot" />
...
class ProductsTest extends KernelTestCase
{
    public function testValid()
    {
        ...
        $this->assertCount(0, $error);
            ...
            <img src="/path-to-screenshot" alt="Test passed screenshot" className="screenshot" />
            <p className="text-lg leading-relaxed mb-4">
            ...
            <CodeBlock code={`public function testInvalid()
{
    ...
    $this->assertCount(1, $error);
            ...
            <img src="/path-to-screenshot" alt="Validation error screenshot" className="screenshot" />
...
private $ProductName;`} />
            ...
            <img src="/path-to-screenshot" alt="Test passed with validation screenshot" className="screenshot" />
...
public function testBlankInvalid()
{
    $this->assertHasError($this->getEntity()->setProductName(''), 1);
            ...
            <img src="/path-to-screenshot" alt="Error without empty string constraint" className="screenshot" />
