...
const CSSPage: React.FC = () => {
    return (
        <div className="px-4 space-y-12">
            <h1 className="text-4xl font-bold mb-6">CSS: Introduction and Basics</h1>

            <section className="mb-6">
                <h2 className="text-3xl font-semibold mb-4">CSS Objectives</h2>
...
h1 {
    ...
    font-family: Verdana;
            ...
            <section className="mb-6">
                <h2 className="text-3xl font-semibold mb-4">Cascade and Inheritance</h2>

                <h3 className="text-2xl font-semibold mb-4">The Principle of Cascade</h3>
                <p className="text-lg leading-relaxed mb-4">
                ...
                <h3 className="text-2xl font-semibold mb-4">Inheritance</h3>
...
strong {
    ...
    color: red;
            ...
            <section className="mb-6">
                <h2 className="text-3xl font-semibold mb-4">Declaring a Stylesheet</h2>
                <p className="text-lg leading-relaxed mb-4">
                ...
                <h3 className="text-2xl font-semibold mb-4">Defining Styles in an HTML Tag</h3>
                <p className="text-lg leading-relaxed mb-4">
...
<body>    
    <h1 style="color:blue;">...</h1> 
                ...
                <h3 className="text-2xl font-semibold mb-4">Defining Styles in the <code className="bg-gray-200 text-red-600">&lt;head&gt;</code> Section</h3>
                <p className="text-lg leading-relaxed mb-4">
...
/* Styles are defined here */
            ...
            <section className="mb-6">
                <h2 className="text-3xl font-semibold mb-4">Defining Global Styles in a Separate CSS File</h2>
                <p className="text-lg leading-relaxed mb-4">
