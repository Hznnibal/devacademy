...
const FontsPage: React.FC = () => {
    return (
        <div className="px-4 space-y-12">
            <h1 className="text-4xl font-bold mb-6">CSS: Positioning</h1>
            ...
            <section className="mb-6">
                <h3 className="text-2xl font-medium mb-4">Position: static</h3>
                <p className="text-lg leading-relaxed mb-4">
...
#two {
    background: #74CC42;
            ...
            <section className="mb-6">
                <h3 className="text-2xl font-medium mb-4">Position: relative</h3>
                <p className="text-lg leading-relaxed mb-4">
    ...
    position: relative;
            ...
            <section className="mb-6">
                <h3 className="text-2xl font-medium mb-4">Position: absolute</h3>
                <p className="text-lg leading-relaxed mb-4">
    ...
    position: absolute;
            ...
            <section className="mb-6">
                <h3 className="text-2xl font-medium mb-4">Explore More</h3>
                <p className="text-lg leading-relaxed">
