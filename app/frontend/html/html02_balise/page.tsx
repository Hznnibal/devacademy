...
const Page: React.FC = () => {
    return (
        <div className=" px-2 space-y-12">
            ...
            {/* Types of Tags */}
            <section>
                <h2 className="text-3xl font-semibold mb-4">Types of Tags</h2>

                {/* Block Type Tags */}
                <div>
                    <h3 className="text-2xl font-medium mb-3">Block-Type Tags</h3>
                    <p className="text-lg leading-relaxed">
                ...
                {/* Inline Type Tags */}
                <div>
                    <h3 className="text-2xl font-medium mt-6 mb-3">Inline-Type Tags</h3>
                    <p className="text-lg leading-relaxed">
            ...
            {/* Section showcasing headers */}

            <section>
                <h2 className="text-3xl font-semibold mb-4">Sectioning</h2>
                <p className="text-lg leading-relaxed">
                ...
                <br />
                <p className="text-lg leading-relaxed">HTML5 has introduced new tags:</p>
                <br />
                <ul className="list-disc list-inside space-y-2">
                    <li>
                ...
                <br />
                <p className="text-lg leading-relaxed">Example usage of <code className="text-red-600 bg-gray-200 px-1 py-0.5 rounded">&lt;div&gt;</code>:</p>
                <br />
...
<div>
    <div>
        <p>Hello world!</p>
            ...
            <section>
                <h2 className="text-3xl font-semibold mb-4">Other Tags</h2>

                {/* Hierarchical headers */}
                <h3 className="text-2xl font-semibold mb-3">Hierarchical Headers</h3>
                <p className="text-lg leading-relaxed">
...
<h6>H6 Header - Least important</h6>`}
                ...
                <br />
                <h4 className="text-lg font-semibold mb-2">Expected Output:</h4>
                <div className="space-y-2">
                    <h1 className="text-4xl font-bold">H1 Header - Most important</h1>
                    <h2 className="text-3xl font-semibold">H2 Header - Less important than H1</h2>
                ...
                {/* Line break tag */}
                <h3 className="text-2xl font-semibold mb-3">The Line Break Tag &lt;br&gt;</h3>
                <p className="text-lg leading-relaxed">
                ...
                {/* Horizontal line tag */}
                <h3 className="text-2xl font-semibold mb-3">The Horizontal Line Tag &lt;hr&gt;</h3>
                <p className="text-lg leading-relaxed">
            ...
            <section>
                <h2 className="text-3xl font-semibold mb-4">Task to Complete</h2>
                ...
                <br />
                <h3 className="text-2xl font-semibold mb-2">Example of HTML Structure:</h3>
                <pre className="bg-black text-blue-50 p-4 rounded">
                    <code>
                        {`<!DOCTYPE html>
<html lang="en">
