...
const ConditionalActionsPage: React.FC = () => {
    return (
        <div className="px-6 py-8 space-y-12">
            <h1 className="text-4xl font-bold text-center mb-10">JS 07: Conditional and Alternative Instructions</h1>

            {/* Introduction to Conditional Action */}
            <section className="space-y-6">
                <h2 className="text-3xl font-semibold">Conditional Action</h2>
            ...
            <section className="space-y-6">
                <h3 className="text-2xl font-semibold">Diagram</h3>
                <pre className="bg-black text-blue-50 p-4 rounded">
                    {`If _predicate_ then
   Instruction 1
   Instruction 2
   ...
...
End if`}
            ...
            <section className="space-y-6">
                ...
                <div className="bg-black text-blue-50 p-4 rounded">
...
End if`}
            ...
            {/* Syntax Explanation */}
            <section className="space-y-6">
                <h3 className="text-2xl font-semibold">JavaScript Syntax</h3>
                <p className="text-lg leading-relaxed">
   ...
   // Instruction N
            ...
            <section className="space-y-6">
                <h3 className="text-2xl font-semibold">Simple Condition</h3>
                <p className="text-lg leading-relaxed">
...
if (response == "yes") {
   ...
   console.log("Good answer!");`}
            ...
            <section className="space-y-6">
                <h3 className="text-2xl font-semibold">Using if-else</h3>
                <p className="text-lg leading-relaxed">
   ...
   // Execute if condition is false
            ...
            {/* Switch Statement */}
            <section className="space-y-6">
                <h3 className="text-2xl font-semibold">Switch Statement</h3>
                <p className="text-lg leading-relaxed">
   ...
   default:
      // code block if no case is matched;
            ...
            <section className="space-y-6">
                <h2 className="text-3xl font-semibold">Introduction to Logical Operators</h2>
                <p className="text-lg leading-relaxed">
            ...
            {/* Using AND (&&) */}
            <section className="space-y-6">
                <h3 className="text-2xl font-semibold">Using AND (&&)</h3>
                <p className="text-lg leading-relaxed">
...
if (age > 18 && permis == "Car") {
    console.log("You are over 18 AND have a car driving license, you can drive");
            ...
            {/* Using OR (||) */}
            <section className="space-y-6">
                <h3 className="text-2xl font-semibold">Using OR (||)</h3>
                <p className="text-lg leading-relaxed">
...
if (age > 18 || permis == "Car") {
    console.log("You are over 18 OR have a car driving license, you can drive");
            ...
            <section className="space-y-6">
                <h3 className="text-2xl font-semibold">Other Logical Comparison Operators</h3>
                <p className="text-lg leading-relaxed">
    ...
    console.log("You are over 18 OR have a car driving license, you can drive");
                ...
                <table className="min-w-full bg-gray-200 p-4 rounded">
                    <thead>
                        <tr>
            ...
            <section className="space-y-6">
                <h3 className="text-2xl font-semibold">Using Else and Else-If</h3>
                <p className="text-lg leading-relaxed">
    ...
    console.log("Unknown answer.");
            ...
            {/* Example 1 */}
            <section className="space-y-6">
                <h3 className="text-2xl font-semibold">Example 1</h3>
                <p className="text-lg leading-relaxed">
...
switch (variable) {   
  ...
  case "3":
     ...
     break; 
            ...
            {/* Example 2 */}
            <section className="space-y-6">
                <h3 className="text-2xl font-semibold">Example 2</h3>
                <p className="text-lg leading-relaxed">
                    Let's check a model:
                </p>
                <pre className="bg-black text-blue-50 p-4 rounded">
...
switch (model) {   
  ...
  case "C3" :
     ...
     break;
            ...
            {/* Using Default Case */}
            <section className="space-y-6">
                <h3 className="text-2xl font-semibold">Using Default Case</h3>
                <p className="text-lg leading-relaxed">
...
switch (model) {   
  ...
  default: 
     console.log("Model "+model+": Unknown brand");
            ...
            {/* Grouping Cases */}
            <section className="space-y-6">
                <h3 className="text-2xl font-semibold">Grouping Cases</h3>
                <p className="text-lg leading-relaxed">
...
switch (model) {   
  ...
  default: 
     console.log("Model "+model+": Unknown brand");
            ...
            {/* Nested Conditions */}
            <section className="space-y-6">
                <h3 className="text-2xl font-semibold">Nested Conditions</h3>
                <p className="text-lg leading-relaxed">
...
if (answer == "yes") {   
   ...
   if (score == 20) {
       console.log("You won!");
            ...
            {/* Ternary Condition */}
            <section className="space-y-6">
                <h3 className="text-2xl font-semibold">Ternary Condition</h3>
                <p className="text-lg leading-relaxed">
...
(age >= 18) ? console.log("You are an adult") : console.log("You are a minor");`}
            ...
            {/* Exercise 1 - Parity */}
            <section className="space-y-6">
                <h2 className="text-3xl font-semibold">Exercise 1 - Parity</h2>
                <p className="text-lg leading-relaxed">
            ...
            {/* Exercise 2 - Age */}
            <section className="space-y-6">
                <h2 className="text-3xl font-semibold">Exercise 2 - Age</h2>
                <p className="text-lg leading-relaxed">
            ...
            <section className="space-y-6">
                <h2 className="text-3xl font-semibold">Exercise 3 - Calculator</h2>
                <p className="text-lg leading-relaxed">
