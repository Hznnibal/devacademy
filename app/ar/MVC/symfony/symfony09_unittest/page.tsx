...
class ProductsTest extends KernelTestCase
{
    public function testValid()
    {
        ...
        $this->assertCount(0, $error);
            ...
            <img src="/path-to-screenshot" alt="نتيجة اجتياز الاختبار" className="screenshot" />
            <p className="text-lg leading-relaxed mb-4">
            ...
            <CodeBlock code={`public function testInvalid()
{
    ...
    $this->assertCount(1, $error);
            ...
            <img src="/path-to-screenshot" alt="خطأ التحقق" className="screenshot" />
...
private $ProductName;`} />
            ...
            <img src="/path-to-screenshot" alt="الاختبار اجتاز مع التحقق" className="screenshot" />
...
public function testBlankInvalid()
{
    $this->assertHasError($this->getEntity()->setProductName(''), 1);
            ...
            <img src="/path-to-screenshot" alt="خطأ بدون قيد السلسلة الفارغة" className="screenshot" />
