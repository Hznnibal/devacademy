...
export function PreparationSteps() {
        ...
        <section className="mb-12">
            ...
            <div className="space-y-6">
                <div className="bg-card p-6 rounded-lg">
                    <h3 className="text-xl font-medium mb-3">1. تكوين متغيرات البيئة</h3>
  ...
  MAILER_DSN=\${MAILER_DSN}`} />
                ...
                <div className="bg-card p-6 rounded-lg">
                    <h3 className="text-xl font-medium mb-3">2. تكوين منصة Platform.sh</h3>
  ...
  hooks:
      ...
      deploy: |
          ...
          php bin/console doctrine:migrations:migrate --no-interaction`} />
                ...
                <div className="bg-card p-6 rounded-lg">
                    <h3 className="text-xl font-medium mb-3">3. تكوين الخدمات</h3>
