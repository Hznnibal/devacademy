...
const CSSPage: React.FC = () => {
    return (
        ...
        <div className="px-5 py-8 font-sans">
            <h1 className="text-3xl font-semibold mb-6 text-center">CSS: Selectors</h1>
            <section className="mb-6">
                <h2 className="text-2xl font-semibold mb-2">Basic Selectors</h2> <div className="border-b border-gray-300 mb-6" />
...
<body>
    ...
    color: red;
            ...
            <section className="mb-6">
                <h2 className="text-2xl font-semibold mb-2">Multiple Selectors</h2> <div className="border-b border-gray-300 mb-6" />
                <p className="text-lg leading-relaxed mb-4">
    ...
    color: red;
                ...
                <h3 className="text-xl font-semibold mb-4">Other Selectors</h3>
                <p className="text-lg leading-relaxed mb-4">
                ...
                <h3 className="text-xl font-semibold mb-4">Pseudo-Classes</h3>
                <p className="text-lg leading-relaxed mb-4">
    ...
    color: red;
                ...
                <h3 className="text-xl font-semibold mb-4">Other Common Pseudo-Classes</h3>
                <ul className="list-disc list-inside space-y-2 text-lg leading-relaxed mb-6">
                ...
                <h3 className="text-xl font-semibold mb-4">Pseudo-Elements</h3>
                <p className="text-lg leading-relaxed mb-4">
    ...
    content: "*";
            ...
            <section className="mb-6">
                <h2 className="text-2xl font-semibold mb-2">Exercises: Your Turn!</h2> <div className="border-b border-gray-300 mb-6" />
