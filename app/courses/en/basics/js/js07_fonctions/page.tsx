...
`} />
      ...
      <section className="mb-6">
        ...
        <ul className="list-disc pl-6">
          <li><code>product(x, y)</code> which returns the product of the two variables <code>x</code> and <code>y</code> passed as parameters.</li>
          <li><code>displayImg(image)</code> which displays the image passed as a parameter (the image path).</li>
        </ul>
        <p className="text-lg leading-relaxed mb-4">
