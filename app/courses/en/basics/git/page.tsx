    ...
    return (
        <div className="container mx-auto py-12">
            ...
            <div className="space-y-12">
                <section>
                    <h2 className="text-2xl font-bold mb-6">Présentation</h2> <div className="border-b border-gray-300 mb-6" />
                ...
                <section>
                    <h2 className="text-2xl font-bold mb-6">Installation</h2> <div className="border-b border-gray-300 mb-6" />
                ...
                <section>
                    <h2 className="text-2xl font-bold mb-6">Initial Configuration</h2> <div className="border-b border-gray-300 mb-6" />
                    <div className="grid gap-6 md:grid-cols-2">
                ...
                <section>
                    <h2 className="text-2xl font-bold mb-6">Basic Commands</h2> <div className="border-b border-gray-300 mb-6" />
                    <div className="grid gap-6 md:grid-cols-2">
                ...
                <section>
                    <h2 className="text-2xl font-bold mb-6">Basic Workflow</h2> <div className="border-b border-gray-300 mb-6" />
                    <div className="grid gap-6 md:grid-cols-2">
                ...
                <section>
                    <h2 className="text-2xl font-bold mb-6">Branch Management</h2> <div className="border-b border-gray-300 mb-6" />
                    <div className="grid gap-6 md:grid-cols-2">
                ...
                <section>
                    <h2 className="text-2xl font-bold mb-6">Best Practices</h2> <div className="border-b border-gray-300 mb-6" />
                    <Card className="p-6">
                ...
                <section>
                    <h2 className="text-2xl font-bold mb-6">GitHub Workflow</h2> <div className="border-b border-gray-300 mb-6" />
                    <Card className="p-6">
